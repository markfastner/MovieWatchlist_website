...
function LandingPage() {
    return (<div className="min-h-screen bg-no-repeat w-full bg-cover 
        ...
        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <input class="shadow appearance-none border border-black-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Password"></input>
            </div>
